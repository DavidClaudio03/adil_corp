    ...
    >
          ...
          >
            ...
            <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap" className="w-full sm:w-auto max-w-xs">
              ...
              >
                ...
                <ArrowRight
                  className="h-3 w-3 flex-shrink-0 group-hover:translate-x-1 transition-transform duration-200"
                  aria-hidden="true"
                />
              </Button>
            </motion.div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
          ...
          <motion.p
            className="text-xs sm:text-sm text-black text-center max-w-3xl mx-auto leading-relaxed"
            variants={itemVariants}
          >
            {description}
          </motion.p>
